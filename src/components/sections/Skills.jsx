            ...
            <div className="border p-2 rounded-md border-slate-300 dark:border-zinc-800">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {stack.frontend.map((skill) => (
                  <div key={skill} className="border font-mono rounded-xl px-2 py-1 border-zinc-300 dark:border-zinc-700 dark:text-slate-400 text-sm hover:bg-(--accent) hover:text-white cursor-pointer transition-all duration-200">
                    {skill}
                  </div>
                ))}
              </div>
            ...
            <div className="border p-2 rounded-md border-slate-300 dark:border-zinc-800">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {stack.backend.map((skill) => (
                  <div key={skill} className="border font-mono rounded-full px-2 py-1 border-zinc-300 dark:border-zinc-700 dark:text-slate-400 text-sm hover:bg-(--accent) hover:text-(--white-90) cursor-pointer transition-all duration-200">
                    {skill}
                  </div>
                ))}
              </div>
